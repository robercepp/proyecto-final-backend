...
async function purchase() {
  ...
  const mail = {
    ...
    mensaje: `
        ${name} ${lastName}. Email: ${email}<br>
        con domicilio en: ${userDomicilio}<br>
        -solicita los siguientes productos:<br>
        ${products}
